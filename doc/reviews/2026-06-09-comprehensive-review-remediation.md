...
- [ ] T9 MED features/client/router.feature implementation-coupled wording — rewrite or demote to docs.
- [ ] T10 MED remaining fixed sleeps in shared bus suite (multi-handler + multi-domain now deadline-polled; other sites at old lines 78,141,192,256,573 remain). Sentinel + deadline-poll.
- [~] T11 MED partial (`8ea42461`): stale C-15 workaround test deleted. Mega-test per-contract-fn split remains (needs shared-container fixture or generated tests).
