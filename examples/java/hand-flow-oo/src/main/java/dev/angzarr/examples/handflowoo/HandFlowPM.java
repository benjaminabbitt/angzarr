 ...
 *
 * <p>This PM orchestrates poker hand flow by: - Tracking when hands start and complete -
 * Coordinating between table and hand domains
 *
 * <p>Uses Struct as a minimal protobuf state type for demonstration. In production, you would
 * define a proper protobuf state message.
 */
