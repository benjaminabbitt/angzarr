 ...
 *
 * <p>This is a mutable state object that gets updated as events are applied. It is not exposed
 * externally - the aggregate provides read-only access via properties.
 */
