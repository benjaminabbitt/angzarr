 ...
 *
 * <p>This tracks the orchestration state separately from the domain state in the hand aggregate. It
 * coordinates: - Phase transitions - Action timeouts - Next player to act - Blind posting sequence
 */
public class HandProcess {
  ...
  public HandPhase getPhase() {
    return phase;
  }

  public void setPhase(HandPhase phase) {
    this.phase = phase;
  }
  ...
  public void setBettingPhase(int bettingPhase) {
    this.bettingPhase = bettingPhase;
  }

  public Map<Integer, PlayerProcessState> getPlayers() {
    return players;
  }

  public List<Integer> getActivePositions() {
  ...
  public void setActionOn(int actionOn) {
  ...
  public void setLastAggressor(int lastAggressor) {
  ...
  public Instant getActionStartedAt() {
    return actionStartedAt;
  }

  public void setActionStartedAt(Instant actionStartedAt) {
  ...
  public void setCommunityCardCount(int communityCardCount) {
