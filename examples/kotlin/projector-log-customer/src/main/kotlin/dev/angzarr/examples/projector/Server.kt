/**
 * Customer Log Projector - Kotlin Implementation
 */
...
private val logger = LoggerFactory.getLogger("CustomerLogProjector")
private const val PROJECTOR_NAME = "log-customer"

/**
 * gRPC service adapter for customer log projector.
 */
class CustomerLogProjectorService(
...
fun main() {
    val port = System.getenv("PORT")?.toIntOrNull() ?: 50056

    val logic: LogProjectorLogic = DefaultCustomerLogProjectorLogic()
    val service = CustomerLogProjectorService(logic)
