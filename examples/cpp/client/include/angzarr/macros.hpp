...
#define ANGZARR_HANDLES(T)                                                              \
    static inline const bool _handles_##T##_registered =                                \
        (register_handler(ANGZARR_TYPE_SUFFIX(T),                                       \
                          [](auto* self, const ::google::protobuf::Any& any, int seq) { \
                              T cmd;                                                    \
                              any.UnpackTo(&cmd);                                       \
...
#define ANGZARR_APPLIES(T)                                                                  \
    static inline const bool _applies_reg_##T =                                             \
        (register_applier(ANGZARR_TYPE_SUFFIX(T),                                           \
                          [](auto* self, auto& state, const ::google::protobuf::Any& any) { \
                              T event;                                                      \
                              any.UnpackTo(&event);                                         \
...
#define ANGZARR_REACTS_TO(T)                                                                  \
    static inline const bool _reacts_reg_##T =                                                \
        (register_event_handler(                                                              \
             ANGZARR_TYPE_SUFFIX(T),                                                          \
             [](auto* self, const ::google::protobuf::Any& any, const std::string& corr_id) { \
                 T event;                                                                     \
                 any.UnpackTo(&event);                                                        \
...
#define ANGZARR_PREPARES(T)                                                            \
    static inline const bool _prepares_reg_##T =                                       \
        (register_prepare_handler(ANGZARR_TYPE_SUFFIX(T),                              \
                                  [](auto* self, const ::google::protobuf::Any& any) { \
                                      T event;                                         \
                                      any.UnpackTo(&event);                            \
