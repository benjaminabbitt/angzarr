...
use angzarr::interfaces::saga::Saga as SagaTrait;
use angzarr::proto::saga_coordinator_server::{SagaCoordinator, SagaCoordinatorServer};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    health_reporter
        .set_serving::<SagaCoordinatorServer<LoyaltyService>>()
        .await;
