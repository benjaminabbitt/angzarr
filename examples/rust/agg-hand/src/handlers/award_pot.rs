    ...
    Ok(EventBook {
        ...
        pages: vec![
            EventPage {
                ...
                event: Some(pack_event(&pot_awarded, "examples.PotAwarded")),
                created_at: Some(now.clone()),
            },
            EventPage {
                sequence: Some(event_page::Sequence::Num(seq + 1)),
                event: Some(pack_event(&hand_complete, "examples.HandComplete")),
                created_at: Some(now),
            },
        ],
        snapshot: None,
