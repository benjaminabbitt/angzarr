...
impl FulfillmentService {
    fn new() -> Self {
        Self {
            logic: FulfillmentLogic::new(),
        }
    }
}

#[tonic::async_trait]
impl BusinessLogic for FulfillmentService {
    async fn handle(
        &self,
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let port = env::var("PORT").unwrap_or_else(|_| "50058".to_string());
    ...
    health_reporter
        .set_serving::<BusinessLogicServer<FulfillmentService>>()
        .await;
