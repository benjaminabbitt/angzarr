...
func HandleAwardPot(
	...
	potAwardedAny.TypeUrl = "type.poker/examples.PotAwarded"
	...
	handCompleteAny.TypeUrl = "type.poker/examples.HandComplete"
	...
	return &pb.EventBook{
		...
		Pages: []*pb.EventPage{
			...
			{
				Sequence:  &pb.EventPage_Num{Num: seq + 1},
				Event:     handCompleteAny,
				CreatedAt: timestamppb.New(now),
			},
		},
	}, nil
