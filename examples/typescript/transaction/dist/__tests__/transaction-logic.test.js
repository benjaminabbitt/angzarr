...
import { TransactionLogic } from '../transaction-logic.js';
import { emptyTransactionState } from '../transaction-state.js';
...
describe('TransactionLogic', () => {
    ...
    describe('handleCreateTransaction', () => {
        ...
        it('throws failed_precondition for existing transaction', () => {
            ...
            expect(() => logic.handleCreateTransaction(state, 'cust-002', items)).toThrow(CommandValidationError);
            try {
        ...
        it('throws invalid_argument for empty customer ID', () => {
            ...
            expect(() => logic.handleCreateTransaction(state, '', items)).toThrow(CommandValidationError);
            try {
        ...
        it('throws invalid_argument for empty items', () => {
            const state = emptyTransactionState();
            expect(() => logic.handleCreateTransaction(state, 'cust-001', [])).toThrow(CommandValidationError);
            try {
    ...
    describe('handleApplyDiscount', () => {
        ...
        it('throws failed_precondition for non-pending transaction', () => {
            ...
            expect(() => logic.handleApplyDiscount(completedState, 'percentage', 10)).toThrow(CommandValidationError);
            try {
    ...
    describe('handleCompleteTransaction', () => {
        ...
        it('throws failed_precondition for non-pending transaction', () => {
            ...
            expect(() => logic.handleCompleteTransaction(emptyState, 'card')).toThrow(CommandValidationError);
            try {
    ...
    describe('handleCancelTransaction', () => {
        ...
        it('throws failed_precondition for completed transaction', () => {
            ...
            expect(() => logic.handleCancelTransaction(completedState, 'too late')).toThrow(CommandValidationError);
            try {
...
//# sourceMappingURL=transaction-logic.test.js.map