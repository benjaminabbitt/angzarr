#!/bin/bash
# Post-create setup for Java client devcontainer
...
echo ""
echo "Java client development environment ready!"
echo "  - JDK 21"
echo "  - Gradle wrapper"
echo ""
echo "Quick start:"
echo "  just build        # Build the client library"
echo "  just test         # Run Cucumber tests"
