...
const (
	EventStreamService_Subscribe_FullMethodName = "/angzarr.EventStreamService/Subscribe"
)
...
func (c *eventStreamServiceClient) Subscribe(ctx context.Context, in *EventStreamFilter, opts ...grpc.CallOption) (grpc.ServerStreamingClient[EventBook], error) {
...
type EventStreamService_SubscribeClient = grpc.ServerStreamingClient[EventBook]
...
func (UnimplementedEventStreamServiceServer) Subscribe(*EventStreamFilter, grpc.ServerStreamingServer[EventBook]) error {
...
func _EventStreamService_Subscribe_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(EventStreamServiceServer).Subscribe(m, &grpc.GenericServerStream[EventStreamFilter, EventBook]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type EventStreamService_SubscribeServer = grpc.ServerStreamingServer[EventBook]
