# Shared Business Configuration Variables
# Copy this file into each provider-specific domain module
# These define WHAT the domain does (portable across providers)
