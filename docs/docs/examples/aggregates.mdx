...
```csharp title="illustrative - OO handler"
[CommandHandler]
...
```java title="illustrative - OO handler"
@CommandHandler
public FundsDeposited handleDeposit(DepositFunds cmd) {
...
```python file=examples/python/player/agg/handlers.py start=docs:start:reserve_funds_imp end=docs:end:reserve_funds_imp
```
...
```csharp title="illustrative - OO reserve handler"
[CommandHandler]
...
```java title="illustrative - OO reserve handler"
@CommandHandler
public FundsReserved handleReserve(ReserveFunds cmd) {
...
```python file=examples/python/player/agg/state.py start=docs:start:state_router end=docs:end:state_router
```
...
```csharp title="illustrative - OO state appliers"
[Applies]
...
```java title="illustrative - OO state appliers"
@Applies
