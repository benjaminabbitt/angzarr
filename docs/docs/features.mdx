...
Editions let you branch history. The main timeline continues undisturbed while you explore alternates—simulations, what-if analysis, ML training data. When you're done, delete the branch. Or promote it to reality.
