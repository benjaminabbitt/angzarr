...
```go file=examples/go/hand-flow/process.go start=docs:start:pm_state end=docs:end:pm_state
```
...
```go file=examples/go/hand-flow/main.go start=docs:start:pm_handler end=docs:end:pm_handler
```
