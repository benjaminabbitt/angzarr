...
```python file=examples/python/pmg-hand-flow/hand_flow_pm.py start=docs:start:pm_state_oo_oo end=docs:end:pm_state_oo_oo
```

</TabItem>
<TabItem value="go" label="Go">

```go file=examples/go/pmg-hand-flow/main.go start=docs:start:pm_state_oo_oo end=docs:end:pm_state_oo_oo
```

</TabItem>
<TabItem value="rust" label="Rust">

```rust file=examples/rust/pmg-hand-flow/src/main.rs start=docs:start:pm_state_oo_oo end=docs:end:pm_state_oo_oo
```

</TabItem>
<TabItem value="java" label="Java">

```java file=examples/java/hand-flow-oo/src/main/java/dev/angzarr/examples/handflowoo/HandFlowPM.java start=docs:start:pm_state_oo_oo end=docs:end:pm_state_oo_oo
```

</TabItem>
<TabItem value="csharp" label="C#">

```csharp file=examples/csharp/HandFlowOO/HandFlowPM.cs start=docs:start:pm_state_oo_oo end=docs:end:pm_state_oo_oo
```

</TabItem>
<TabItem value="cpp" label="C++">

```cpp file=examples/cpp/hand-flow-oo/src/hand_flow_pm.hpp start=docs:start:pm_state_oo_oo end=docs:end:pm_state_oo_oo
```
...
```rust file=examples/rust/pmg-hand-flow/src/main.rs start=docs:start:pm_handler_oo end=docs:end:pm_handler_oo
```
