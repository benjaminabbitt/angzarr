...
```python file=examples/python/player/agg/handlers/commands.py start=docs:start:deposit_guard end=docs:end:deposit_guard
```
...
```python file=examples/python/player/agg/handlers/commands.py start=docs:start:deposit_validate end=docs:end:deposit_validate
```
...
```python file=examples/python/player/agg/handlers/commands.py start=docs:start:deposit_compute end=docs:end:deposit_compute
```
...
```python file=examples/python/player/agg/handlers/test_commands.py start=docs:start:unit_test_deposit end=docs:end:unit_test_deposit
```
