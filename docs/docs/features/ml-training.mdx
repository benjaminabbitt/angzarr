...
This lets you start simple—training directly against the event store—and migrate to isolated infrastructure only when load demands it. No upfront complexity tax.
