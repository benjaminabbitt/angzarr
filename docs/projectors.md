...
| Language | File |
|----------|------|
| Rust | [examples/rust/projector-receipt/src/lib.rs](../examples/rust/projector-receipt/src/lib.rs) |
| Go | [examples/go/projector-receipt/logic/receipt.go](../examples/go/projector-receipt/logic/receipt.go) |
| Python | [examples/python/projector-receipt/receipt_projector.py](../examples/python/projector-receipt/receipt_projector.py) |
...
|----------|--------|------|
| Rust | customer | [examples/rust/projector-log-customer/src/lib.rs](../examples/rust/projector-log-customer/src/lib.rs) |
| Rust | transaction | [examples/rust/projector-log-transaction/src/lib.rs](../examples/rust/projector-log-transaction/src/lib.rs) |
| Go | customer | [examples/go/projector-log-customer/logic/log.go](../examples/go/projector-log-customer/logic/log.go) |
| Go | transaction | [examples/go/projector-log-transaction/logic/log.go](../examples/go/projector-log-transaction/logic/log.go) |
| Python | customer | [examples/python/projector-log-customer/server.py](../examples/python/projector-log-customer/server.py) |
| Python | transaction | [examples/python/projector-log-transaction/server.py](../examples/python/projector-log-transaction/server.py) |
...
| Feature | File |
|---------|------|
| Receipt generation | [examples/features/projector-receipt.feature](../examples/features/projector-receipt.feature) |
| Event logging | [examples/features/projector-log.feature](../examples/features/projector-log.feature) |
...
# Go
cd examples/go/projector-receipt && go test ./logic/...

# Python
cd examples/python/projector-receipt && uv run pytest test_*.py
```
...
```bash
# Rust
cargo test -p projector-receipt --test cucumber

# Go
cd examples/go/projector-receipt && go test ./features/...

# Python
cd examples/python/projector-receipt && uv run pytest features/
```
