...
If you need multi-domain subscription, you probably need a **[Process Manager](../process-manager/process-manager.md)**.
...
| Language | File |
|----------|------|
| Rust | [examples/rust/saga-loyalty-earn/src/lib.rs](../../../examples/rust/saga-loyalty-earn/src/lib.rs) |
| Go | [examples/go/saga-loyalty-earn/logic/saga_logic.go](../../../examples/go/saga-loyalty-earn/logic/saga_logic.go) |
| Python | [examples/python/saga-loyalty-earn/server.py](../../../examples/python/saga-loyalty-earn/server.py) |
...
| Feature | File |
|---------|------|
| Loyalty points award | [examples/features/saga_loyalty_earn.feature](../../../examples/features/saga_loyalty_earn.feature) |
...
```bash
# Rust
cargo test -p saga-loyalty-earn --lib

# Go
cd examples/go/saga-loyalty-earn && go test ./logic/...

# Python
cd examples/python/saga-loyalty-earn && uv run pytest test_*.py
```
...
```bash
# Rust
cargo test -p saga-loyalty-earn --test cucumber

# Go
cd examples/go/saga-loyalty-earn && go test ./features/...

# Python
cd examples/python/saga-loyalty-earn && uv run pytest features/
```
